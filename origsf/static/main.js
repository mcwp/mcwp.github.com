...
function publishQuiz(title) {
  FB.ui({
    method: 'stream.publish',
    attachment: {
      name: title,
      caption: "I know U.S. state flowers.",
      media: [{
        type: 'image',
        href: 'http://stateflowermcp.appspot.com/',
        src: 'http://stateflowermcp.appspot.com/splash.jpg'
      }]
    },
    action_links: [{
      text: 'Do you know U.S. state flowers?',
      href: 'http://stateflowermcp.appspot.com/'
    }],
    user_message_prompt: 'Tell your friends about this quiz:'
  });
}
